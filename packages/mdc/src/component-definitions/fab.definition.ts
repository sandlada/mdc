...
const extendedShared = createStyleDefinition({
    ...
    'medium-container-padding-inline-start': `26px`,
    'medium-container-padding-inline-end'  : `26px`,
    ...
    'large-container-padding-inline-start': `28px`,
    'large-container-padding-inline-end'  : `28px`,
