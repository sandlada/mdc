...
const DefaultScheme = createStyleDefinition({
    ...
    'badge-height': `16px`,
    'badge-width': `16px`,
    'badge-label-color': Color.OnError,
    'badge-label-size': Typescale.LabelSmall.FontSize,
    'badge-label-line-height': Typescale.LabelSmall.LineHeight,
    'badge-label-font': Typescale.LabelSmall.Font,
    'badge-label-tracking': Typescale.LabelSmall.Tracking,
    'badge-label-font-weight': Typescale.LabelSmall.FontWeight,
...
export const NavigationRailVerticalTabDefinition = createStyleDefinition<Partial<IScheme>>({
    ...
    'icon-container-block-leading-space': `0px`,
    'icon-container-block-trailing-space': `0px`,
    'icon-container-inline-leading-space': `12px`,
    'icon-container-inline-trailing-space': `12px`,
