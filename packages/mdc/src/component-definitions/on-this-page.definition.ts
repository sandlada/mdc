...
export const OnThisPageDefinition = createStyleDefinition({
    ...
    'enabled-container-inline-leading-padding-space'        : Space.Space0,
    'enabled-container-inline-trailing-padding-space'       : Space.Space0,
    'enabled-container-block-leading-padding-space'         : Space.Space0,
    'enabled-container-block-trailing-padding-space'        : Space.Space0,
...
export const OnThisPageItemDefinition = createStyleDefinition({
    ...
    'enabled-container-inline-leading-padding-space'        : Space.Space200,
    'enabled-container-inline-trailing-padding-space'       : Space.Space200,
    'enabled-container-block-leading-padding-space'         : Space.Space50,
    'enabled-container-block-trailing-padding-space'        : Space.Space50,
