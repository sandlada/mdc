...
import type { DialogAnimationArgs } from '../dialog/internal/dialog-animations'
import type { TNavigationTabDirection } from '../navigation-item-old/base-navigation-tab'
import { NavigationBarTab } from '../navigation-item-old/navigation-bar-tab'
...
export class NavigationBar extends composeMixin(
